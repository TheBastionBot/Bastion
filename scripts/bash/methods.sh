...
function method::help () {
  ...
  echo " --reset      Removes all the data stored by Bastion. Useful when you"
...
function method::reset () {
  ...
  then
    ...
    print::info "Stop Bastion before resetting the saved data."
  else
    print::message "Resetting Bastion..."
    ...
    rm -fr ./data/Bastion.db ./package-lock.json ./screenlog.0
    print::message "Done."
    echo

    print::message "All the saved data was removed from Bastion."
  fi
}
