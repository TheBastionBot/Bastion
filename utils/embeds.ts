...
export const generateBastionEmbed = (embed: string | MessageEmbedOptions): MessageEmbedData => {
    ...
    return {
        ...
        fields: embed.fields,
        footer: embed.footer,
        image: embed.image ? typeof embed.image === "string" ? embed.image : embed.image.url : undefined,
        thumbnail: embed.thumbnail ? typeof embed.thumbnail === "string" ? embed.thumbnail : embed.thumbnail.url : undefined,
        timestamp: embed.timestamp,
        title: embed.title,
        url: embed.url,
    };
