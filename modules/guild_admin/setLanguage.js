    ...
    if (args.list) {
      return message.channel.send({
        embed: {
          ...
          description: `Bastion's translations are a community effort. If you want to see Bastion translated into another language we'd love your help. Visit our [translation site](https://18n.bastionbot.org) for more info.\n\nCurrenty it's available in the following languages:\n${Bastion.strings.availableLanguages.join(', ').toUpperCase()}`
        }
      }).catch(e => {
        Bastion.log.error(e);
      });
